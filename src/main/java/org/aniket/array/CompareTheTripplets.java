...
/*
 ** Problem: Compare the tripplets **  ref:https://www.hackerrank.com/challenges/compare-the-triplets/problem?h_r=next-challenge&h_v=zen
...
public class CompareTheTripplets {
	public static void main(String[] args) throws IOException {
	 ...
	 public static List<Integer> compareTriplets(List<Integer> a, List<Integer> b) {
		 ...
		 System.out.println("Receives:alice=>"+a+"   and  bob=>"+b);
		 int alicePoints=0;
		 int bobPoints=0;
